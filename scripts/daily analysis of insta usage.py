...
file_path = '/Users/berinayzumrasariel/Desktop/extracted_likes_timestamps.csv'  # Replace with the correct file path
...
# Analyze Instagram usage by academic period
for period_name, (start_date, end_date) in academic_periods.items():
    # Filter data for the current period and create a copy to avoid the warning
